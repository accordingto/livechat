// Beta uses the same Firebase project with separate rooms/kangaroo-beta-{CODE} nodes.
// This configuration is an independent copy; no additional database rules are required.
