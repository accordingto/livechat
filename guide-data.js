  ...
  taboo: {
    ...
    sections: [
      ...
      { icon: '🕹️', title: GUIDE_TITLES.how, steps: [
        ...
        { zh: `裁判聽到禁字按 ${B('is-red', '🚨 Taboo!')} 舉發，由主持人裁決：成立則裁判 +2、描述者 −1。`,
          en: `The referee taps ${B('is-red', '🚨 Taboo!')} on a slip and the host rules: upheld is +2 referee, −1 clue giver.` },
      ]},
      ...
      { icon: '🎭', title: GUIDE_TITLES.roles, roles: [
        ...
        { emoji: '👀', name: { zh: 'Referee 裁判', en: 'Referee' },
          desc: { zh: '看得到禁字但不能搶答。舉發成立 +2，這是裁判唯一的得分方式。',
                  en: 'Sees the forbidden list, cannot buzz. An upheld call is +2 — their only way to score.' } },
