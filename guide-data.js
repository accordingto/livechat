  ...
  hottake: {
    ...
    sections: [
      ...
      { icon: '🕹️', title: GUIDE_TITLES.how, steps: [
        ...
        { zh: `請少數派先講理由——通常最有話題性。聊完之後，任何人在自己的卡片上按 ${B('is-accent', '🎡 換下一題')}（再按一次確認）就換下一題，舊的票會自動失效。`,
          en: `Let the minority side argue first; that is where the talk is. When it runs dry, anyone taps ${B('is-accent', '🎡 Next take')} on their own card and taps again to confirm — the next take spins and old votes clear.` },
      ]},
      { icon: '📱', title: { zh: '玩家手機上會看到什麼', en: 'What players see on their phones' },
        ...
        note: { zh: '這款的題目<b>會</b>印在卡片上，因為投票的當下每個人都要能再讀一次那句話。投完主持人畫面的長條就即時長出來。最下面那顆「換下一題」誰按都可以，按下去會先問一次「再按一次確認」才真的換，免得討論到一半被手滑切掉。',
                en: 'Here the take <b>is</b> printed on the card, because everyone needs to re-read it at the moment they vote. The bars on the host screen fill in as the taps land. Anyone may tap “next” at the bottom; it asks for a second tap to confirm first, so a stray touch can’t cut the talk short.' } },
  ...
  sophies: {
    ...
    sections: [
      ...
      { icon: '🕹️', title: GUIDE_TITLES.how, steps: [
        ...
        { zh: `逐一用英文說明理由；選 C 的人要說出自己的第三條路。聊完之後，任何人在自己的卡片上按 ${B('is-accent', '🎲 換下一個情境')}（再按一次確認）就換下一題。`,
          en: `Go around and justify each pick in English. Anyone on C spells out their third way. When it winds down, anyone taps ${B('is-accent', '🎲 Next situation')} on their own card and taps again to confirm.` },
      ]},
      { icon: '📱', title: { zh: '玩家手機上會看到什麼', en: 'What players see on their phones' },
        phones: [
        ...
        note: { zh: '卡片上<b>刻意不印情境本文</b>——情境留在你分享的畫面上。再印一次只會讓所有人整段時間低頭看手機。最下面那顆「換下一個情境」誰按都可以，按下去會先問一次「再按一次確認」才真的換。',
                en: 'The scenario is deliberately left off the card — it stays on the screen you are sharing. Printing it twice just sends everyone’s eyes down to their phones. Anyone may tap “next” at the bottom; it asks for a second tap to confirm first.' } },
      { icon: '🙋', title: GUIDE_TITLES.who, roles: [
        { emoji: '🎙️', name: { zh: '主持人', en: 'Host' },
  ...
  scene: {
    ...
    sections: [
      ...
      { icon: '🕹️', title: GUIDE_TITLES.how, steps: [
        ...
        { zh: `每個人用角色的身分做一句自我介紹，然後直接開始演。演完之後，任何人在自己的卡片上按 ${B('is-accent', '🎭 換下一個場景')}（再按一次確認），就會換場景並重新發角色。`,
          en: `Each player introduces themselves in one line, in character. Then just play. When the scene has run its course, anyone taps ${B('is-accent', '🎭 Next scene')} on their own card and taps again to confirm — a new scene is drawn and roles are re-dealt.` },
      ]},
      { icon: '📱', title: { zh: '玩家手機上會看到什麼', en: 'What players see on their phones' },
        phones: [
