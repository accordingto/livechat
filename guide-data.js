  ...
  hottake: {
    ...
    sections: [
      ...
      { icon: '🕹️', title: GUIDE_TITLES.how, steps: [
        ...
        { zh: `請少數派先講理由——通常最有話題性。聊完的人在卡片上按 ${B('is-accent', '👋 我好了，換下一題')}，超過半數按了就自動抽下一題，舊的票會自動失效。`,
          en: `Let the minority side argue first; that is where the talk is. When someone is done they tap ${B('is-accent', "👋 I'm ready for the next one")} on their card; once more than half the room has, the next take spins itself and old votes clear.` },
      ]},
          ...
          { caption: { zh: '還沒投票', en: 'Before voting' },
            card: { name: 'Amy', color: 1,
                    ...
                    buttons: [
                      ...
                      { label: { zh: '👋 我好了，換下一題', en: "👋 I'm ready for the next one" }, cls: 'is-accent' },
                    ],
                    hint: { zh: '0 / 4 位準備好了 · 3 位就換下一題', en: '0 of 4 ready · next one at 3' } } },
        ],
        note: { zh: '這款的題目<b>會</b>印在卡片上，因為投票的當下每個人都要能再讀一次那句話。投完主持人畫面的長條就即時長出來。最下面那顆是「換下一題」——一個人按不會換，要超過半數的人都按了才會抽，免得有人手快把討論切斷。',
                en: 'Here the take <b>is</b> printed on the card, because everyone needs to re-read it at the moment they vote. The bars on the host screen fill in as the taps land. The bottom button is “next”: one tap does nothing on its own — the next take is drawn once more than half the room has tapped it, so nobody can cut the talk short.' } },
  ...
  sophies: {
    ...
    sections: [
      ...
      { icon: '🕹️', title: GUIDE_TITLES.how, steps: [
        ...
        { zh: `逐一用英文說明理由；選 C 的人要說出自己的第三條路。講完的人在卡片上按 ${B('is-accent', '👋 我好了，換下一題')}，超過半數按了就自動抽下一個情境。`,
          en: `Go around and justify each pick in English. Anyone on C spells out their third way. Whoever is done taps ${B('is-accent', "👋 I'm ready for the next one")} on their card; once more than half the room has, the next situation draws itself.` },
      ]},
      { icon: '📱', title: { zh: '玩家手機上會看到什麼', en: 'What players see on their phones' },
        phones: [
        ...
        note: { zh: '卡片上<b>刻意不印情境本文</b>——情境留在你分享的畫面上。再印一次只會讓所有人整段時間低頭看手機。最下面那顆是「換下一題」，要超過半數的人都按了才會抽下一個情境。',
                en: 'The scenario is deliberately left off the card — it stays on the screen you are sharing. Printing it twice just sends everyone’s eyes down to their phones. The bottom button is “next”: the following situation is drawn once more than half the room has tapped it.' } },
      { icon: '🙋', title: GUIDE_TITLES.who, roles: [
        { emoji: '🎙️', name: { zh: '主持人', en: 'Host' },
  ...
  persuade: {
    ...
    sections: [
      ...
      { icon: '🕹️', title: GUIDE_TITLES.how, steps: [
        ...
        { zh: `判決出來之後，每張卡片上都會出現 ${B('is-accent', '🎲 下一個場景')}，誰先按都可以——判決本身就是這一輪的結尾，不用再等誰。`,
          en: `Once the verdict is in, every card shows ${B('is-accent', '🎲 Next scenario')} and whoever taps first draws it — the verdict already ended the round, so there is nothing left to wait for.` },
      ]},
  ...
  scene: {
    ...
    sections: [
      ...
      { icon: '🕹️', title: GUIDE_TITLES.how, steps: [
        ...
        { zh: `每個人用角色的身分做一句自我介紹，然後直接開始演。演完的人在卡片上按 ${B('is-accent', '👋 我好了，換下一題')}，超過半數按了就自動抽下一個場景並重新發角色。`,
          en: `Each player introduces themselves in one line, in character. Then just play. Whoever is done taps ${B('is-accent', "👋 I'm ready for the next one")} on their card; once more than half the room has, the next scene draws itself and roles are re-dealt.` },
      ]},
      { icon: '📱', title: { zh: '玩家手機上會看到什麼', en: 'What players see on their phones' },
        phones: [
          ...
          { caption: { zh: 'Ben 的卡片', en: "Ben's card" },
            card: { name: 'Ben', color: 2,
                    ...
                    buttons: [ { label: { zh: '👋 我好了，換下一題', en: "👋 I'm ready for the next one" }, cls: 'is-accent' } ] } },
        ],
